  ...
  return (
    <Modal onClose={onClose} ariaLabel="Add to Collection">
      <div className="flex justify-between items-center">
        ...
        <button type="button" onClick={onClose} aria-label="Close collection modal"><X className="w-5 h-5 text-gray-500 dark:text-slate-400" /></button>
      </div>
      ...
      <div className="space-y-2">
        ...
        {selectedCollection && (
          <button type="button" onClick={() => addMutation.mutate(selectedCollection)}
      ...
      <div className="border-t border-gray-200 dark:border-slate-700 pt-4 space-y-2">
        ...
        <input id="addcoll-or-create-new" type="text" value={newName} onChange={(e) => setNewName(e.target.value)}
          ...
          className="w-full rounded-lg bg-gray-100 dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-gray-900 dark:text-white px-3 py-2" />
        {newName && (
          <button type="button" onClick={() => createAndAddMutation.mutate()}
