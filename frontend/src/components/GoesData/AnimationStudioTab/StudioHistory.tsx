                  ...
                  <>
                    ...
                    {anim.output_path && (
                      <a
                        ...
                        download
                        aria-label={`Download ${anim.name}`}
                        className="text-xs text-primary hover:underline focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-hidden rounded"
                      >
                        Download
                      </a>
                    )}
