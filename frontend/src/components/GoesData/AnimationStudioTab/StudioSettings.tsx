...
export function StudioSettings({
  animName, setAnimName, fps, setFps, format, setFormat,
  quality, setQuality, cropPresetId, setCropPresetId,
  falseColor, setFalseColor, scale, setScale, cropPresets,
  canGenerate, isPending, isSuccess, isError, onGenerate,
}: StudioSettingsProps) {
  return (
    <div className="space-y-4">
      <div className="bg-gray-50 dark:bg-slate-900 rounded-xl p-6 border border-gray-200 dark:border-slate-800 space-y-4">
        ...
        <div>
          <label htmlFor="anim-fps-fps" className="block text-xs text-gray-400 dark:text-slate-500 mb-1">FPS: {fps}</label>
