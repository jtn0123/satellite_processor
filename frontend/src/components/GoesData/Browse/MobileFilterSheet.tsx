  ...
  return (
    <BottomSheet open={open} onClose={onClose} title="Filters">
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="bs-band" className="block text-xs text-gray-400 dark:text-slate-500 mb-1">
            Band
          </label>
          <select
            id="bs-band"
        ...
        <div>
          <label htmlFor="bs-tag" className="block text-xs text-gray-400 dark:text-slate-500 mb-1">
            Tag
          </label>
          <select
            id="bs-tag"
        ...
        <div>
          <label htmlFor="bs-sort" className="block text-xs text-gray-400 dark:text-slate-500 mb-1">
            Sort by
          </label>
          <select
            id="bs-sort"
