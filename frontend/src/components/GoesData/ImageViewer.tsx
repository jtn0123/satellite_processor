      ...
      <div className="flex items-center justify-between p-4 text-white">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-2 hover:bg-white/10 rounded-lg focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-hidden"
            title="Zoom in"
            aria-label="Zoom in"
          >
          ...
          <span
            className="text-sm text-white/50 w-16 text-center"
            aria-live="polite"
      ...
      >
        {currentIndex > 0 && (
          <button
            ...
            className="absolute left-4 z-10 p-3 bg-black/50 hover:bg-black/70 rounded-full text-white focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-hidden"
          >
        ...
        {currentIndex < frames.length - 1 && (
          <button
            ...
            className="absolute right-4 z-10 p-3 bg-black/50 hover:bg-black/70 rounded-full text-white focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-hidden"
          >
