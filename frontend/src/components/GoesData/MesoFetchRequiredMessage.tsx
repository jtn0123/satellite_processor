...
export default function MesoFetchRequiredMessage({
  onFetchNow,
  isFetching,
  fetchFailed,
  errorMessage,
  ...
  if (isFetching) {
    return (
      <div
        ...
        data-testid="meso-fetch-loading"
      >
  ...
  return (
    <div
      className="flex flex-col items-center justify-center gap-4 text-center p-8"
      data-testid="meso-fetch-required"
    >
      <p className="text-white/70 text-sm">
        No live preview available for mesoscale sectors — CDN images are not provided by NOAA.
      </p>
      {fetchFailed && (
