  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 text-gray-900 dark:text-white text-[10px] font-bold rounded-full flex items-center justify-center">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-space-900 border border-subtle rounded-xl shadow-xl z-50 overflow-hidden">
