...
export const BAND_INFO: Record<string, BandInfo> = {
  C01: {
    ...
    category: 'Visible',
    color: '#3b82f6',
    description: 'Daytime aerosol, smoke detection',
  },
  C02: {
    name: 'Red',
    wavelength: '0.64μm',
    category: 'Visible',
    color: '#ef4444',
    description: 'Primary visible band, clouds & surface',
  },
  C03: {
    name: 'Veggie',
    wavelength: '0.86μm',
    category: 'Near-IR',
    color: '#22c55e',
    description: 'Vegetation, burn scars, aerosols',
  },
  C04: {
    name: 'Cirrus',
    wavelength: '1.37μm',
  ...
  C06: {
    ...
    category: 'Near-IR',
    color: '#f97316',
    description: 'Cloud particle size, snow',
  },
  C07: {
    name: 'Shortwave IR',
    wavelength: '3.9μm',
    category: 'IR',
    color: '#dc2626',
    description: 'Fire detection, fog at night',
  },
  C08: {
    name: 'Upper Tropo WV',
    wavelength: '6.2μm',
    category: 'IR',
    color: '#6366f1',
    description: 'Upper-level water vapor, jets',
  },
  C09: {
    name: 'Mid Tropo WV',
    wavelength: '6.9μm',
  ...
  C10: {
    ...
    category: 'IR',
    color: '#a78bfa',
    description: 'Lower-level water vapor, SO₂',
  },
  C11: {
    ...
    category: 'IR',
    color: '#14b8a6',
    description: 'Cloud-top phase, dust',
  },
  C12: {
    name: 'Ozone',
    wavelength: '9.6μm',
    category: 'IR',
    color: '#84cc16',
    description: 'Total ozone, turbulence',
  },
  C13: {
    name: 'Clean IR',
    wavelength: '10.3μm',
    category: 'IR',
    color: '#eab308',
    description: 'Clean IR window, clouds & surface temp',
  },
  C14: {
    name: 'IR Longwave',
    wavelength: '11.2μm',
    category: 'IR',
    color: '#f59e0b',
    description: 'IR longwave window, cloud-top temp',
  },
  C15: {
    name: 'Dirty IR',
    wavelength: '12.3μm',
    category: 'IR',
    color: '#d97706',
    description: 'Dirty IR, volcanic ash',
  },
  C16: {
    name: 'CO₂ Longwave',
    wavelength: '13.3μm',
    category: 'IR',
    color: '#78716c',
    description: 'CO₂ longwave, cloud-top height',
  },
};
...
export const HIMAWARI_BAND_INFO: Record<string, BandInfo> = {
  ...
  B02: {
    ...
    category: 'Visible',
    color: '#22c55e',
    description: 'True color green component',
  },
  B03: {
    name: 'Red',
    wavelength: '0.64μm',
...
export function getBandLabel(bandId: string, satellite?: string): string {
  const infoMap = satellite
    ? getBandInfoForSatellite(satellite)
    : { ...BAND_INFO, ...HIMAWARI_BAND_INFO };
