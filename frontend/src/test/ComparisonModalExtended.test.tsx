...
const frameA = {
  ...
  thumbnail_path: '/t1.png', image_url: '/api/satellite/frames/test-id/image', thumbnail_url: '/api/satellite/frames/test-id/thumbnail', file_size: 1024, width: 100, height: 100,
};
