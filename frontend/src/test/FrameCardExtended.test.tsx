...
const baseFrame: GoesFrame = {
  ...
  width: 5424,
  height: 5424,
  thumbnail_path: '/thumbs/f1.jpg', image_url: '/api/satellite/frames/test-id/image', thumbnail_url: '/api/satellite/frames/test-id/thumbnail',
...
describe('FrameCard — grid mode', () => {
  ...
  it('renders without thumbnail when thumbnail_path is null', () => {
    const frame = { ...baseFrame, thumbnail_path: null, image_url: '/api/satellite/frames/test-id/image', thumbnail_url: '/api/satellite/frames/test-id/thumbnail' };
