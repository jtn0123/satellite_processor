...
const frame = { id: 'f1', satellite: 'GOES-16', band: 'C02', sector: 'CONUS', capture_time: '2026-01-01T00:00:00Z', file_path: '', thumbnail_path: '', image_url: '/api/satellite/frames/test-id/image', thumbnail_url: '/api/satellite/frames/test-id/thumbnail', file_size: 1024, width: 1920, height: 1080, tags: [], collections: [] };
