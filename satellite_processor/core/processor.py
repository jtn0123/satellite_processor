...
import re
import sys
from PyQt6.QtCore import pyqtSignal, QObject, QThread, QTimer, QMetaObject, Qt
...
class SatelliteImageProcessor(QObject):  # Change from BaseImageProcessor to QObject
    ...
    def some_method(self):
        from satellite_processor.gui.widgets.video_options import VideoOptionsWidget  # Moved import
    ...
    def _process_image_subprocess(self, image_path: Path, options: dict) -> Optional[np.ndarray]:
