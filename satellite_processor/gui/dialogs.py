...
class SettingsDialog(QDialog):
    ...
    def load_current_settings(self):
        ...
        self.default_crop_height.setValue(
            self.settings.get("default_crop_height", 1080)
        )
        ...
        self.default_encoder.setCurrentText(
            self.settings.get("default_encoder", "H.264 (Maximum Compatibility)")
        )
